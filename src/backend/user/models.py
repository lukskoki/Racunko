...
class Profile(models.Model):
    ...
    group = models.ForeignKey(Group,on_delete=models.PROTECT, blank=True, null=True, related_name="members") #dodao da se moze preko group.members.all() dobiti lista membera
